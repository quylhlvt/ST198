...
import com.female.maker.oc.creator.dialog.CreateNameDialog
...
import com.female.maker.oc.creator.ui.view.ViewActivity
...
import com.female.maker.oc.creator.utils.DataHelper.setMargins
...
import com.female.maker.oc.creator.utils.share.telegram.TelegramSharing
import com.female.maker.oc.creator.utils.share.whatsapp.IdGenerator
import com.female.maker.oc.creator.utils.share.whatsapp.StickerBook
import com.female.maker.oc.creator.utils.share.whatsapp.StickerPack
import com.female.maker.oc.creator.utils.share.whatsapp.WhatsappSharingActivity
...
import com.female.maker.oc.creator.utils.toList
import com.female.maker.oc.creator.R
import com.female.maker.oc.creator.databinding.ActivityMyCreationBinding
        ...
        AvatarAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvAvatar.setMargins(12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),50)
                        checkLongClick = true
        ...
        DesignAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvDesign.setMargins(12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),50)
                        checkLongClick = true
                        this@MyCreationActivity.checkLongClick = true
                        if (arrCheckTick.indexOf(pos) > -1) {
                            arrCheckTick.remove(pos)
...
//
    ...
    fun hideLongClick() {
        this@MyCreationActivity.binding.rcvAvatar.setMargins(12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),0)
        this@MyCreationActivity.binding.rcvDesign.setMargins(12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),12.dp(this@MyCreationActivity),0)
