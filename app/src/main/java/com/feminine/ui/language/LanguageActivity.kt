...
import com.feminine.ui.tutorial.TutorialActivity
...
import com.feminine.databinding.ActivityLanguageBinding
...
class LanguageActivity : AbsBaseActivity<ActivityLanguageBinding>() {
    ...
    override fun initView() {
        ...
        if (codeLang.equals("")) {
//            binding.actionBar.backCustom.visibility = View.GONE
...
//            binding.tvTitle1.visibility = View.GONE
            ...
            binding.actionBar.save.visibility = View.VISIBLE
        }
...
//
        ...
        binding.actionBar.save.onSingleClick {
            saveLang()
        }
    }
