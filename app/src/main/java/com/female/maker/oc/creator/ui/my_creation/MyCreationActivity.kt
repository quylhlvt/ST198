        ...
        AvatarAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvAvatar.setMargins(15.dp(this@MyCreationActivity),16.dp(this@MyCreationActivity),15.dp(this@MyCreationActivity),50)
                        checkLongClick = true
        ...
        DesignAdapter().apply {
            onClick = { pos, type ->
                when (type) {
                    ...
                    "longclick" -> {
                        this@MyCreationActivity.binding.rcvDesign.setMargins(15.dp(this@MyCreationActivity),16.dp(this@MyCreationActivity),15.dp(this@MyCreationActivity),50)
                        checkLongClick = true
                        this@MyCreationActivity.checkLongClick = true
                        if (arrCheckTick.indexOf(pos) > -1) {
                            arrCheckTick.remove(pos)
...
//            tvShare.isSelected = true
    ...
    fun hideLongClick() {
        this@MyCreationActivity.binding.rcvAvatar.setMargins(15.dp(this@MyCreationActivity),16.dp(this@MyCreationActivity),15.dp(this@MyCreationActivity),0)
        this@MyCreationActivity.binding.rcvDesign.setMargins(15.dp(this@MyCreationActivity),16.dp(this@MyCreationActivity),15.dp(this@MyCreationActivity),0)
